<template>
 <a-row align="middle"   >
<a-col :sm="{ span: 20 , offset:2   }"   :xs="{ span: 24    }" :lg="{ span: 16, offset: 4 }" :xxl="{ span: 10, offset: 7 }"   :xl="{ span: 14, offset: 5 }"  >  
...
export default {
  components: {  Image, MyForm },
  data() {
    return {
      playlist_id : "6tDwXyLI9DRcqQ8e9yDSVA"
    }
  },
}
</script>